...
public class MyCacheAnnotationParser implements CacheAnnotationParser, Serializable {
  ...
  CacheEvictOperation parseEvictAnnotation(AnnotatedElement ae, DefaultCacheConfig defaultConfig,
  ...
  CacheOperation parsePutAnnotation(AnnotatedElement ae, DefaultCacheConfig defaultConfig,
                                    CachePut cachePut) {
  ...
  private <A extends Annotation> Collection<A> getAnnotations(AnnotatedElement ae,
  ...
  private void validateCacheOperation(AnnotatedElement ae, CacheOperation operation) {
    if (StringUtils.hasText(operation.getKey()) && StringUtils
    ...
    if (StringUtils.hasText(operation.getCacheManager()) && StringUtils
        .hasText(operation.getCacheResolver())) {
      throw new IllegalStateException("Invalid cache annotation configuration on '" +
                                      ae.toString()
  ...
  public boolean equals(Object other) {
    return (this == other || other instanceof MyCacheAnnotationParser);
  }

  @Override
  public int hashCode() {
    return MyCacheAnnotationParser.class.hashCode();
  }
  ...
  static class DefaultCacheConfig {
    ...
    private DefaultCacheConfig(String[] cacheNames, String keyGenerator, String cacheManager,

...
public class MyAnnotationCacheOperationSource extends AbstractFallbackCacheOperationSource
  ...
  /**
   * Create a default MyAnnotationCacheOperationSource, supporting public methods
   * that carry the {@code Cacheable} and {@code CacheEvict} annotations.
   */
  public MyAnnotationCacheOperationSource() {

    this(true);
  }

  /**
   * Create a default {@code MyAnnotationCacheOperationSource}, supporting public methods
   * that carry the {@code Cacheable} and {@code CacheEvict} annotations.
   *
   ...
   */
  public MyAnnotationCacheOperationSource(boolean publicMethodsOnly) {
    this.publicMethodsOnly = publicMethodsOnly;
    this.annotationParsers = new LinkedHashSet<CacheAnnotationParser>(1);
    this.annotationParsers.add(new MyCacheAnnotationParser());
  }

  /**
   * Create a custom MyAnnotationCacheOperationSource.
   *
   * @param annotationParser the CacheAnnotationParser to use
   */
  public MyAnnotationCacheOperationSource(CacheAnnotationParser annotationParser) {
   ...
   */
  public MyAnnotationCacheOperationSource(CacheAnnotationParser... annotationParsers) {
    this.publicMethodsOnly = true;
    Assert.notEmpty(annotationParsers, "At least one CacheAnnotationParser needs to be specified");
    Set<CacheAnnotationParser>
        parsers =
        new LinkedHashSet<CacheAnnotationParser>(annotationParsers.length);
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof MyAnnotationCacheOperationSource)) {
      return false;
    }
    MyAnnotationCacheOperationSource otherCos = (MyAnnotationCacheOperationSource) other;
